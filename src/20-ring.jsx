const Ring = React.memo(function Ring({activeTimer,napSug,tick,recentEvents,lang,showOrbit,screenLockActive}){
  ...
  return(<div style={{position:"relative",width:sz,margin:"0 auto"}}>
    <div style={{position:"relative",width:sz,height:sz}}>
      ...
      {/* v11.9.130: orb "nebulosa líquida" (opção B do mockup orb-premium) — substitui a
          nebulosa difusa v11.9.82 por uma esfera com matéria: 3 massas de cor se misturando
          em ciclos de 17-21s (classes .orb-liq*), rim light no topo + glow por estado
          (dia lilás/ciano · soneca roxo calmo · noite índigo quase apagado). No banho o
          orb sai de cena — a água (v11.9.115) é a protagonista do miolo. */}
      {!isBath&&(()=>{
        const pal=isBedtime
          ?{b1:"rgba(79,70,229,0.30)",b2:"rgba(49,46,129,0.28)",b3:"rgba(139,124,246,0.23)",glow:"rgba(67,56,202,0.22)"}
          :isNap
          ?{b1:"rgba(139,124,246,0.41)",b2:"rgba(99,102,241,0.38)",b3:"rgba(196,181,253,0.32)",glow:"rgba(99,102,241,0.26)"}
          :{b1:"rgba(196,181,253,0.55)",b2:"rgba(34,211,238,0.50)",b3:"rgba(244,114,182,0.42)",glow:"rgba(139,124,246,0.30)"};
        return(<div style={{position:"absolute",top:"50%",left:"50%",width:sz*0.56,height:sz*0.56,transform:"translate(-50%,-50%)",borderRadius:"50%",overflow:"hidden",pointerEvents:"none",background:"radial-gradient(circle at 50% 36%,#151b48 0%,#0a0e2e 72%)",boxShadow:`inset 0 1px 10px rgba(255,255,255,0.10), inset 0 -14px 28px rgba(0,0,0,0.5), 0 0 46px ${pal.glow}`,transition:"box-shadow 1.2s ease"}}>
          <div className="orb-liq orb-liqA" style={{width:"95%",height:"95%",left:"-18%",top:"-14%",background:`radial-gradient(circle, ${pal.b1}, transparent 62%)`}}/>
          <div className="orb-liq orb-liqB" style={{width:"88%",height:"88%",right:"-16%",top:"16%",background:`radial-gradient(circle, ${pal.b2}, transparent 62%)`}}/>
          <div className="orb-liq orb-liqC" style={{width:"80%",height:"80%",left:"8%",bottom:"-20%",background:`radial-gradient(circle, ${pal.b3}, transparent 62%)`}}/>
          <div style={{position:"absolute",inset:0,borderRadius:"50%",background:"radial-gradient(ellipse 60% 28% at 50% 10%,rgba(255,255,255,0.16),transparent 60%)"}}/>
        </div>);
      })()}
