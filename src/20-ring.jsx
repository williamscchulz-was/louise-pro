  ...
  return(<div style={{position:"relative",width:sz,margin:"0 auto"}}>
    <div style={{position:"relative",width:sz,height:sz}}>
      ...
      {timerArc&&<>
        ...
        {!isBath&&!isNap&&<div style={{position:"absolute",left:timerArc.tipX-5,top:timerArc.tipY-5,width:10,height:10,borderRadius:"50%",background:timerArc.col,boxShadow:`0 0 7px ${timerArc.col}aa, 0 0 16px ${timerArc.col}55`,animation:"cometTip 1.5s ease-in-out infinite",zIndex:5}}/>}
      </>}
