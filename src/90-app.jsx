      ...
      {isSwipePage?<div style={{overflow:"hidden",width:"100%",touchAction:"pan-y"}}>
        ...
        {!activeTimer&&<div style={{display:"grid",gridTemplateColumns:"repeat(3,minmax(0,1fr))",gap:8,padding:"0 20px",marginBottom:12}}>
          {quickSuggestions.map(tp=>{
            ...
            const SHORT={wakeup:_lang==="en"?"Woke up":"Acordou",bottle:_lang==="en"?"Bottle":"Mamad.",nursing:_lang==="en"?"Nurse":"Amam.",diaper:_lang==="en"?"Diaper":"Fralda",sleep:_lang==="en"?"Sleep":"Sono",nap:_lang==="en"?"Nap":"Soneca",bath:_lang==="en"?"Bath":"Banho",medicine:_lang==="en"?"Medicine":"Medic."};
